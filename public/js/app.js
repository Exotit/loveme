            ...
            .state('goto', {
                ...
                resolve: {
                    slideData: function ($http, $stateParams) {
                        return $http({
                            method: 'GET',
                            url: "/chapter/" + $stateParams.chapter + "/slide/" + $stateParams.slide
                        });
                    }
                },
                views: {
